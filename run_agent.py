...
class AIAgent:
    ...
    def _format_turn_completion_explanation(
        ...
        # that nobody wired up here. Silence here is the user-visible blank
        # this explainer exists to prevent; name no speculative cause.
        return (
            prefix
    ...
    def _compress_context(
        ...
        *,
        ...
        try:
            ...
            # Compression may drop or summarise tool results referenced by
            # request/task read memos. Clear both suppression layers only after
            # the upstream fenced compression attempt has settled.
            try:
