            ...
            try:
                ...
                if _mem_provider_name:
                    ...
                    if self._memory_manager.providers:
                        ...
                        # HERMES-HOOK-IDENTITY-AIAGENT-BEGIN
                        # Thread tenant identity for per-tenant memory isolation.
                        # honcho provider reads this via kwargs.get("tenant_id").
                        if self._tenant_id:
                            _init_kwargs["tenant_id"] = self._tenant_id
                        # HERMES-HOOK-IDENTITY-AIAGENT-END
