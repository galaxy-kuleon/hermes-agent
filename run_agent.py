    ...
    def _ensure_db_session(self) -> None:
        ...
        try:
            self._session_db.create_session(
                ...
                # Persist the platform user_id so dashboards and analytics can
                # filter API-server sessions per end-user. The session_id is
                # also scoped, but storing user_id makes that relationship
                # queryable without parsing identifiers.
