...
# Used at KG file/tool authorization boundaries. user_groups is a
# comma-separated string of stable OpenWebUI group IDs.
...
def set_session_vars(
    ...
    KG authorization boundaries. ``user_groups`` is a comma-separated string of stable
